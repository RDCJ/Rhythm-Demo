...
public class Reporter : MonoBehaviour
{
	...
	bool showMemButton = false;
	bool showFpsButton = false;
	bool showSearchText = true;
	bool showCopyButton = false;
	bool showSaveButton = false;

    string buildDate = "none";
	string logDate;
	float logsMemUsage;
	float graphMemUsage;
	...
	void drawToolBar()
	{
		...
		GUI.skin = toolbarScrollerSkin;
		Vector2 drag = getDrag();
		if ((drag.x != 0) && (downPos != Vector2.zero) && (downPos.y > Screen.height - size.y * 2f - BRTopSize)) {
	...
	public void OnGUIDraw()
	{
		...
		screenRect.x = 0;
		screenRect.y = BRTopSize;
		screenRect.width = Screen.width;
		screenRect.height = Screen.height - BRTopSize;

		getDownPos();


		logsRect.x = 0f;
		logsRect.y = size.y * 2f + BRTopSize;
		logsRect.width = Screen.width;
		logsRect.height = Screen.height * 0.75f - size.y * 2f - BRTopSize;
